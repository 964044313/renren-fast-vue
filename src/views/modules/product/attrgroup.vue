    ...
    <el-col :span="18">
      <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
          <el-form-item>
            <el-input v-model="dataForm.key" placeholder="分组id/组名" clearable></el-input>
          </el-form-item>
          <el-form-item>
        ...
        >
          ...
          <el-table-column prop="icon" header-align="center" align="center" label="组图标">
            <template slot-scope="scope">
              <img :src="scope.row.icon" width="20px" height="20px"/>
            </template>
          </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      url_t: "https://tse4-mm.cn.bing.net/th/id/OIP-C.8sykTQhzOC5b5YUMmdWZ_gHaEK?pid=ImgDet&rs=1",
      fill_t: "fill",
      dataList: [],
      pageIndex: 1,
      pageSize: 10,
